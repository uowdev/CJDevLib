...
#WARNING : THIS VERSION HAS MAILBOX AND OFFICE LICENSE FUNCTIONALITY DISABLED DUE TO AN ISSUE WITH MAILBOXES BEING CREATED WITHOUT AN EXCHANGE GUID 
 
NOT TESTED FOR AT LEAST A MONTH as of sept. 2017
<-----------------------------------------------------------------------------------------------------------------------------------------------------------------------#>
